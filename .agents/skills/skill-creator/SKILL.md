---
name: skill-creator
description: 创建新的 Codex Skill。当用户说"帮我创建一个 skill"、"把这个变成 skill"、"新建技能"时触发。
---
...
**执行**：
1. 创建目录 `.Codex/skills/render-article/`
2. 编写 SKILL.md
3. 测试触发词是否有效
